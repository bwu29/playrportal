export const COUNTRIES = [
  ...
  export const POSITIONS = ["CF", "LF", "RF", "ACM", "DCM", "LCB", "RCB", "LWB", "RWB", "GK"];

  export const PRO_EXPERIENCE = ["0", "1", "2", "3", "4-6", "7-9", "10+"];
  ...
  export const BIRTH_YEARS = Array.from({ length: 2010 - 1984 + 1 }, (_, i) => 2010 - i);
